...
function TrajetPassager(){

  let param = window.location.pathname; //je recupere le parametre de l'url
  let idMembre = param.substr(16,17); //je recupere les valeurs de param et je trie de maniere à garder l'id du membre 

  const [ trajetPassager, setTrajetPassager ] = useState([]);

  useEffect(() => {
    Axios.get('http://localhost:3001/trajetsconducteur').then((response) => {
      setTrajetPassager(response.data);
    })
  }, [])
                  ...
                  <div className="container-fluid">
                    <div className="row">
                      <div className="col-2 offset-1">
                        <p><a href={`/trajetconducteur/${idMembre}`}><img src={imageConducteur} id="espace_membre" alt="img" /></a></p>
                      </div>
                      ...
                      <div className="col-9 offset-2">
                        <div id="carouselExampleIndicators" className="carousel slide" data-bs-ride="carousel">
                          ...
                          <div className="carousel-inner">
                            ...
                            {trajetPassager.map((val) => {   
                            return <div className="carousel-item">
                              <div className="row" id="profil-carousel">
                                <div className="col-3">
                                <p>{val.ville1} - {val.ville2}</p>
                                  <p>{val.tarif} euros</p>
                                  <p>{val.nombre_de_passagers} places disponible(s)</p>
                                  <p>Pour le {val.dateTrajet}</p>
                                </div>

                                <div className="col-4 offset-2">
                                  <p>{val.prenom} - {val.nom}</p>
                                  <p>{val.type_de_voiture}</p>
                                  <p>{val.telephone}</p>
