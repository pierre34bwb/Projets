            ...
            <div className="col-2 offset-10">
                <div className="dropdown">
                    ...
                    <ul className="dropdown-menu" aria-labelledby="dropdownMenu2">
                      <li><a href="http://localhost:3000/login"><button className="dropdown-item" type="button" >Connexion</button></a></li>
                      <li><a href="http://localhost:3000/inscription"><button className="dropdown-item" type="button">Inscription</button></a></li>
                    </ul>
                  </div>
            </div>
